...
/*taskKey="com.javarush.task.task05.task0526"
Мужчина и женщина
...
public class task02 {
    public static void main(String[] args) {
        Man man1 = new Man("Vasya", 28, "Hacapetovka");
        Man man2 = new Man("Valera", 32, "Adesa");
        Woman woman1 = new Woman("Galya", 26, "Harkoff");
        Woman woman2 = new Woman("Nadya", 32, "Kyiv");
