package javarush.JavaSyntax.lvl9.lec08;
/*taskKey="com.javarush.task.task09.task0917"\n\nПерехват unchecked-исключений
...
public class task05 {
    public static void main(String[] args) {
        handleExceptions(new task05());
    }

    public static void handleExceptions(task05 obj) {
        try {
            obj.method1();
            obj.method2();
            obj.method3();
