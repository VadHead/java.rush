...
/*taskKey="com.javarush.task.task08.task0804"\n\nВывести на экран список ключей
Есть коллекция Map<String, String>, туда занесли 10 различных строк. Вывести на экран список ключей, каждый элемент с новой строки.
Требования:
